...
/**
 * Implements admin plugin setting of S2 Donation
 *
 * @class   S2_Donation_Plugin_Setting
 * @package S2 Donation
 * @since   1.0.0
 * @author  Shuban Studio <shuban.studio@gmail.com>
 */
if ( ! class_exists( 'S2_Donation_Plugin_Setting' ) ) {

	class S2_Donation_Plugin_Setting extends S2_Settings_API {

		/**
		 * Single instance of the class
		 *
		 * @var \S2_Donation_Plugin_Setting
		 */
		 ...
		 *
		 * @since  1.0.0
		 * @return \S2_Donation_Plugin_Setting
		 */
		...
		public function __construct() {
			...
			if( ! empty( $_POST ) && isset( $_POST['_wpnonce'] ) && wp_verify_nonce( $_POST['_wpnonce'], 's2dn-setting' ) ) {
		...
		?>
			...
			<div class="wrap">
				<form method="post" id="s2-donation-admin-form" action="" enctype="multipart/form-data">
					...
					<input type="hidden" name="action" value="plugin-settings">
...
/**
 * Unique access to instance of S2_Donation_Plugin_Setting class
 *
 * @return \S2_Donation_Plugin_Setting
 */
function S2_Donation_Plugin_Setting() {
	return S2_Donation_Plugin_Setting::get_instance();
}
